...
def run_benchmarking(args):
    ...
    benchmark_df = pd.read_csv(args.dataset_path, sep = '\t', header = None, names = ["sentence", "relationship"]).sample(frac=1)
    ...
    print("Precision of", 100.0 * precision_score(true_labels, predicted_labels, average='micro'))
    print("Recall of", 100.0 * recall_score(true_labels, predicted_labels, average='micro'))
    print("F1 score of", 100.0 * f1_score(true_labels, predicted_labels, average='micro'))
